...
############ Commentaires supplémentaire  #############


# RESTE A FAIRE :
# Faire le chemin des images et des fichiers (PathLib)
# Rendre le code présentable (faire plusieurs dico qui se renvoie dans un seul puis dans la liste final) == ok 
# Vérifier que tout fonctionne bien == ok 
